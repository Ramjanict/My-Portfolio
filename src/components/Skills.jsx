      ...
      <div className=" container mx-auto px-4 ">
        <div className="md:w-[50%] w-[80%] mx-auto space-y-12">
          <h2 className=" capitalize text-lg sm:text-5xl font-extrabold tracking-wider  text-center leading-relaxed">
            my <span className="text-[#313BAC]">skills</span>
          </h2>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-items-center gap-5">
            {skills.map((item, index) => {
              return (
                <div
                  key={index}
                  className="w-24 h-24 bg-white rounded-md hover:shadow-2xl transition-none hover:scale-110"
                >
                  <img
